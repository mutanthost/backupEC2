Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/db_dg_psby_diag.sql /main/1 2018/05/28 15:06:26 bburton Exp $
Rem
Rem db_dg_psby_diag.sql
Rem
Rem Copyright (c) 2017, 2018, Oracle and/or its affiliates. 
Rem All rights reserved.
Rem
Rem    NAME
Rem      db_dg_psby_diag.sql - <one-line expansion of the name>
Rem
Rem    DESCRIPTION
...
Rem    SQL_SOURCE_FILE: tfa/src/v2/tfa_home/resources/sql/db_dg_psby_diag.sql
...
Rem    bburton     09/22/17 - -- This script is to be used to assist in the
Rem                           collection of information to help-- troubleshoot
Rem                           Data Guard issues involving a Physical or Active
Rem                           Standby.
