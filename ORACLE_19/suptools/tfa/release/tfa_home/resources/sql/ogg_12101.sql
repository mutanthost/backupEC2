Rem
Rem $Header: tfa/src/v2/tfa_home/resources/sql/ogg_12101.sql /main/1 2018/05/28 15:06:26 bburton Exp $
Rem
Rem ogg_12101.sql
Rem
...
Rem
Rem    NAME
Rem      ogg_12101.sql - <one-line expansion of the name>
Rem
Rem    DESCRIPTION
...
Rem    SQL_SOURCE_FILE: tfa/src/v2/tfa_home/resources/sql/ogg_12101.sql
...
begin
  ...
  oracle_tfa_verify_init_parameter('compatible', '12.', verbose, 
...
prompt
prompt  ++
prompt  ++ <a name="Performance_Checks"><b>Performance Checks</b></a> ++
prompt  ++
	 ...
	 dbms_output.put_line('+  <b>INFO</b>:  Verify that database parameter streams_pool_size is set appropriately ');
      ...
      if crow_count> 0 then
       ...
       dbms_output.put_line('+');
         ...
         dbms_output.put_line('+') ;
         select count(*) into rcount from cdb_tables where table_name='STREAMS$_APPLY_PROGRESS' and owner = 'SYS' and ini_trans=1;
         if rcount > 0 then
            dbms_output.put_line('+  <b>WARNING</b>:  Increase the INITRANS of SYS.STREAMS$_APPLY_PROGRESS table to match the expected parallelism of the apply processes');
